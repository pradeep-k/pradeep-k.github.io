...
***W&M Undergraduates: Funding is now available for W&M undergraduates with strong Computer Systems or Data Science backgrounds, and who are highly motivated to do work at their intersection.***

***I am teaching a new course in Systems for Deep Learning in Fall, 2023. Current MS and PhD students, please register if you want to know the current state of the art. We will be using Deep-Gencode as an education tool.***
